    ...
    if (!slider) {
      ...
      function showImage(content) {
        ...
        if (slider.querySelector('img')) {
          ...
          slider.querySelector("h2").textContent = content.querySelector("h2").textContent ; 
        slider.querySelector("p").textContent = content.querySelector("p").textContent ;   
        }
      ...
      function showNextImage(){
        ...
        showImage(currentContent.nextElementSibling || slideContainer.firstElementChild)
        }
        function showPrevImage(){
            
            showImage(currentContent.previousElementSibling || slideContainer.lastElementChild)
        }
